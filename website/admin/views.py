...
def admin():
    ...
    return render_template('admin.html', createUserForm=createUserForm)
...
@requires_roles('admin')
def view_all_users():
    return render_template('admin.html', current_users=User.query.all(), createUserForm=createUserForm)
...
@requires_roles('admin')
def view_all_venues():
    return render_template('admin.html', venues=Venue.query.all(), createUserForm=createUserForm)
...
def view_all_artists():
    return render_template('admin.html', artists=Artist.query.all(), createUserForm=createUserForm)
...
def view_all_concerts():
    return render_template('admin.html', concerts=Concert.query.all(), createUserForm=createUserForm)
