...
class CreateVenueForm(FlaskForm):
    name = StringField(validators=[InputRequired(), Length(1, 99, "Name must be less than 100 characters.")])
    location = StringField(validators=[InputRequired(), Length(1, 99, "Location must be less than 100 characters.")])
